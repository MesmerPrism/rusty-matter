...
| `emmons_bell_2015_ijms` | <https://doi.org/10.3390/ijms161126065> | Future categorical species-like head outcome labels; current code uses only qualitative gap-block context. |
| `planformdb_250` | <https://lobolab.umbc.edu/planform/download/> | Future curated experiment/phenotype fixtures after schema, citation, and license review. |
