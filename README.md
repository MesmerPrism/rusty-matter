...
- `rusty-matter-mesh`: dynamic mesh surfaces, stable topology keys, surface
  sampling, coordinate maps, hand validation mesh payloads, and dynamic mesh
...
updates, coordinate maps, hand payloads, dynamic collider, and error/math
helpers. SDF code is split by builder, config, packed grid, geometry helpers,
and errors. Particle code is split by IDs, state, render-neutral payloads,
